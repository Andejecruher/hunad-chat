...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $acces_token = 'EAARPtZC97UEgBQuCIRfZC4ADJbtZC71c2kZCmyOmGDhDBqZCIfuCrSFglmh0YfWINkXCDiMw4TOj3ZC2vZATPdKWczSMf5ZBqYPS1cTxGSzpR2SZAAL5WBQKxn1q0FbKPrCreVeONhl7KTB9qDeiZApZAHO8JxWRiGeSRfkaPeZAhSEHpbV92AJM7jt4ZAfTZBqIdCggZDZD';
        $config = [
            // Campos compatibles con backend (legacy/service expectations)
            'access_token' => Crypt::encryptString($acces_token),
